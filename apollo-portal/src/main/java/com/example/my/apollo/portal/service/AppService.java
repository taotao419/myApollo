...
import com.example.my.apollo.portal.api.AdminServiceAPI;
...
public class AppService {
  ...
  public AppService(final UserInfoHolder userInfoHolder, final AdminServiceAPI.AppAPI appAPI,
      final AppRepository appRepository, final AppNamespaceService appNamespaceService) {
