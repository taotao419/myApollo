...
import com.example.my.apollo.build.ApolloInjector;
import com.example.my.apollo.core.ServiceNameConsts;
...
import com.example.my.apollo.util.ConfigUtil;
import com.example.my.apollo.util.ExceptionUtil;
import com.example.my.apollo.util.http.HttpRequest;
import com.example.my.apollo.util.http.HttpResponse;
import com.example.my.apollo.util.http.HttpUtil;
...
public class ConfigServiceLocator {
    ...
    private HttpUtil m_httpUtil;//m_ 是member的缩写 表示非公共字段
